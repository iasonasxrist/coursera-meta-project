...
SELECT OrderID, Quantity, TotalCost as Cost FROM littleDB.orders
where quantity > 2

-- Task 2

CREATE TABLE `littleDB`.`menuitems` (
...
-- Insert data
INSERT INTO `littleDB`.`menuitems` (`CourseName`, `StarterName`, `DesertName`)
VALUES
...
UPDATE `littleDB`.`menus` SET `MenuItemsID` = '1' WHERE (`MenuID` = '1');
UPDATE `littleDB`.`menus` SET `MenuItemsID` = '2' WHERE (`MenuID` = '2');
UPDATE `littleDB`.`menus` SET `MenuItemsID` = '3' WHERE (`MenuID` = '3');
UPDATE `littleDB`.`menus` SET `MenuItemsID` = '4' WHERE (`MenuID` = '4');
UPDATE `littleDB`.`menus` SET `MenuItemsID` = '5' WHERE (`MenuID` = '5');
UPDATE `littleDB`.`menus` SET `MenuItemsID` = '6' WHERE (`MenuID` = '6');
UPDATE `littleDB`.`menus` SET `MenuItemsID` = '7' WHERE (`MenuID` = '7');
UPDATE `littleDB`.`menus` SET `MenuItemsID` = '8' WHERE (`MenuID` = '8');
UPDATE `littleDB`.`menus` SET `MenuItemsID` = '9' WHERE (`MenuID` = '9');
UPDATE `littleDB`.`menus` SET `MenuItemsID` = '10' WHERE (`MenuID` = '10');

ALTER TABLE `littleDB`.`menus` 
ADD CONSTRAINT `menus_items_menu_fk`
  FOREIGN KEY (`MenuItemsID`)
  REFERENCES `littleDB`.`menuitems` (`MenuItemsID`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION;

----
SELECT cd.CustomerID, cd.Name as FullName, o.OrderID, o.TotalCost as Cost, m.Name as MenuName, mi.CourseName
FROM littleDB.customerdetails as cd
INNER JOIN littleDB.orders as o on o.CustomerID = cd.CustomerID
INNER JOIN littleDB.menus as m on o.MenuItemID = m.MenuItemsID
INNER JOIN littleDB.menuitems as mi on m.MenuItemsID = mi.MenuItemsID
...
FROM littleDB.menus as m
WHERE m.MenuItemsID = ANY (
    SELECT o.MenuItemID
    FROM littleDB.orders as o
...
ALTER TABLE `littleDB`.`customerdetails` 
...
UPDATE `littleDB`.`customerdetails` 
