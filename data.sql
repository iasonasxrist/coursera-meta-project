...
INSERT INTO `littleDB`.`CustomerDetails` (`Name`, `ContactDetail`)
VALUES
...
INSERT INTO `littleDB`.`StaffInformation` (`Name`, `Role`, `Salary`)
VALUES
('Sarah', 'Manager', 55000),
('Tom', 'Waiter', 30000),
('Linda', 'Chef', 40000),
...
INSERT INTO `littleDB`.`Menus` (`Name`, `Type`, `Price`)
VALUES
...
INSERT INTO `littleDB`.`Bookings` (`CustomerID`, `StaffID`, `Date`, `TableNumber`)
VALUES
...
INSERT INTO `littleDB`.`Orders` (`CustomerID`, `MenuItemID`, `StaffID`, `Date`, `Quantity`, `TotalCost`)
VALUES
...
INSERT INTO `littleDB`.`OrderDeliveryStatuses` (`OrderID`, `Date`, `Status`)
VALUES
