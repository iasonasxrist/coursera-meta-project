CREATE DATABASE  `littleDB`  -- CREATE DATABASE
USE `littleDB`;

-- Host: localhost    Database: littleDB
-- ------------------------------------------------------
...
INSERT INTO `bookings` VALUES (1,1,1,'2024-03-01 12:00:00',10),(2,2,2,'2024-03-01 12:30:00',12),(3,3,3,'2024-03-01 13:00:00',14),(4,4,4,'2024-03-01 14:00:00',16),(5,5,5,'2024-03-01 15:00:00',18),(6,6,6,'2024-03-01 16:00:00',20),(7,7,7,'2024-03-01 17:00:00',22),(8,8,8,'2024-03-04 18:00:00',24),(10,10,10,'2024-03-05 20:00:00',28),(11,1,1,'2022-10-10 00:00:00',5),(12,3,2,'2022-11-12 00:00:00',3),(13,2,3,'2022-10-11 00:00:00',2),(14,1,1,'2022-10-13 00:00:00',2),(15,1,1,'2022-10-11 00:00:00',5),(16,1,2,'2022-10-10 00:00:00',5);
...
/*! ALTER TABLE `customerdetails` DISABLE KEYS */;
...
/*! ALTER TABLE `customerdetails` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!  ALTER TABLE `menuitems` DISABLE KEYS */;
...
/*! ALTER TABLE `menuitems` ENABLE KEYS */;
UNLOCK TABLES;
...
/* ALTER TABLE `orderdeliverystatuses` DISABLE KEYS */;
...
/* ALTER TABLE `orderdeliverystatuses` ENABLE KEYS */;
UNLOCK TABLES;
...
/*DROP VIEW IF EXISTS `ordersview3`*/;
SET @saved_cs_client     = @@character_set_client;
/* SET character_set_client = utf8mb4 */;
...
/* ALTER TABLE `staffinformation` DISABLE KEYS */;
...
/* ALTER TABLE `staffinformation` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'littleDB'
--
...
/*VIEW `ordersview` AS select `orders`.`OrderID` AS `OrderID`,`orders`.`Quantity` AS `Quantity`,`orders`.`TotalCost` AS `Cost` from `orders` where (`orders`.`Quantity` > 2) */;
/*SET character_set_client      = @saved_cs_client */;
/*SET character_set_results     = @saved_cs_results */;
/*SET collation_connection      = @saved_col_connection */;
...
/*CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*VIEW `ordersview3` AS select `m`.`Name` AS `MenuName` from `menus` `m` where `m`.`MenuItemsID` in (select `o`.`MenuItemID` from `orders` `o` group by `o`.`MenuItemID` having (sum(`o`.`Quantity`) > 2)) */;
/*SET character_set_client      = @saved_cs_client */;
/*SET character_set_results     = @saved_cs_results */;
/*SET collation_connection      = @saved_col_connection */;
